...
if ($task == "pay") {
	...
	if (has_capability('mod/shop:getpayment', $context)) {
		...
		get_enrolled_users($coursecontext,'moodle/course:view','','u.id,username,firstname,lastname');
		$participants = get_enrolled_users($coursecontext,'moodle/course:view','','u.id,username,firstname,lastname');
