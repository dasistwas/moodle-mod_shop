...
3. Edit all the files in this directory and change all the
   instances of shop to your new module name (eg widget).

4. Place the shop folder into the /mod folder of the moodle
   directory.
...
6. Now go to Modules then to Activities in the Site Administration block
   And you should find that this shop has been added
